...
WEIGHTS_PATH = f"/home/Users/dqy/Dataset/ImageNet100/weights#{STRATEGY}.pt"


def name_to_label():
    root = "/home/Users/dqy/Dataset/ImageNet100/format_ImageNet/images/train/"
...
def calculate_class_weights(dataset, num_classes=365, method='inverse', beta=0.999):
    """
    计算类别权重
    Args:
        dataset: 数据集对象
